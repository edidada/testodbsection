...
namespace odb
{
    ...
    public access::object_traits< ::person >
  {
    ...
    struct nicknames_traits
    {
      ...
      typedef mysql::smart_container_statements< nicknames_traits > statements_type;
    ...
    {
      typedef object_traits_impl<object_type, id_mysql>::image_type image_type;
      typedef object_traits_impl<object_type, id_mysql>::id_image_type id_image_type;
      ...
      typedef mysql::section_statements< object_type, extras_traits > statements_type;
