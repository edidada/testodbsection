...
#include <odb/mysql/section-statements.hxx>
...
namespace odb
{
  ...
  {
    mysql::smart_container_statements_impl< nicknames_traits > nicknames_;

    mysql::section_statements< ::person, extras_traits > extras_;
  ...
  std::size_t access::object_traits_impl< ::person, id_mysql >::extras_traits::
  bind (MYSQL_BIND* b,
        const MYSQL_BIND* id,
        std::size_t id_size,
        image_type& i,
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer_length = static_cast<unsigned long> (
      i.bio_value.capacity ());
    b[n].length = &i.bio_size;
  ...
  bool access::object_traits_impl< ::person, id_mysql >::extras_traits::
  grow (image_type& i,
        my_bool* t)
  {
  ...
  void access::object_traits_impl< ::person, id_mysql >::extras_traits::
  init (object_type& o,
        const image_type& i,
        database* db)
  {
        ...
        const object_type& o)
  {
    ...
    //
    {
      ...
      mysql::value_traits<
        ...
        v);
      i.bio_null = is_null;
      i.bio_size = static_cast<unsigned long> (size);
  ...
  const char access::object_traits_impl< ::person, id_mysql >::extras_traits::
  select_statement[] =
  "SELECT "
  "`person`.`bio` "
  "FROM `person` "
  ...
  load (connection& conn, object_type& obj, section& s)
  {
    ...
    mysql::connection& c (static_cast<mysql::connection&> (conn));
